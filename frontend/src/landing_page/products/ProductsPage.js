...
function ProductsPage() {
  ...
  ></LeftSection>
  <RightSection imageUrl='images/console.png' productName='Console' productDescription='The central dashboard for your Zerodha account. Gain insights into your trades and investments with in-depth reports and visualisations.' linkContent='Learn More' link=''></RightSection>
  ...
  ></LeftSection>
<RightSection imageUrl='images/kiteconnect.png' productName='Kite Connect API' productDescription='Build powerful trading platforms and experiences with our super simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase.' linkContent='Kite Connect' link=''></RightSection>
