    ...
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="images/zerodhaFundhouse.png" style={{width:"20%"}}/>
...
funds to help you save for your goals.
        ...
        <div className="col-4 p-3 mt-5">
          <img src="images/sensibullLogo.svg" style={{width:"20%"}}/>
...
and no mis-selling.</p>
        ...
        <button
          ...
          style={{ width: "20%", margin: "auto" }}  onClick={() => navigate("/signup")}
        >
          Signup Now
        </button>
      </div>
