    ...
    <div className='container'>
      <div className='row'>
        <div className='col-6 p-5'>
          ...
          <p className='text-muted'>That's why 1.6+ crore customers trust us with ~ ₹6 lakh crores of equity investments, making us India’s largest broker; contributing to 15% of daily retail exchange volumes in India.</p>
          
          <h4 className='mt-5'>No spam or gimmicks</h4>
          <p className='text-muted'>No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like. Our philosophies.</p>
          
          <h4 className='mt-5'>The universe</h4>
        ...
        <div className='col-6 p-5'>
          <img src='images/ecosystem.png' style={{width:"75%"}}></img>
